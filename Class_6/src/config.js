...
Put all the hardcorded stuff in your config.js file !!! 

Like if you are using the same things over and over by rewriting it , like image links , configration data etc etc 

this file can also be named as config.js or constants.js or data.js
